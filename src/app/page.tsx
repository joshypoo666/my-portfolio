...
const workProjects: Record<string, Project[]> = {
  UX: [
    ...
    { title: "AI Mobile Design Builder", category: "Mobile", year: "2026", client: "JobNimbus Design Team", heroImageUrl: "/Ai Mobile Design builder/project hero.png", thumbnailUrl: "/Ai Mobile Design builder/forge hero.png", thumbnailPosition: "center" },
