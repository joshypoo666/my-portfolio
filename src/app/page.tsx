...
type Project = { title: string; category: string; year: string; client?: string; tagline?: string; heroImageUrl?: string; challengeImageUrl?: string; subProjects?: SubProject[]; outcomes?: { stats: Outcome[]; reflection: string }; embedUrl?: string; thumbnailUrl?: string; thumbnailPosition?: string };
...
const workProjects: Record<string, Project[]> = {
  UX: [
    ...
    { title: "AI Mobile Design Builder", category: "Mobile", year: "2026", client: "JobNimbus Design Team", tagline: "Mobile was the last thing anyone thought about when AI came along. Forge changed that.", heroImageUrl: "/Ai Mobile Design builder/project hero.png", challengeImageUrl: "/Ai Mobile Design builder/dual forge.png", thumbnailUrl: "/Ai Mobile Design builder/forge hero.png", thumbnailPosition: "center" },
