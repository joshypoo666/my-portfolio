...
type Project = { title: string; category: string; year: string; client?: string; tagline?: string; heroImageUrl?: string; subProjects?: SubProject[]; outcomes?: { stats: Outcome[]; reflection: string }; embedUrl?: string; thumbnailUrl?: string; thumbnailPosition?: string };
...
const workProjects: Record<string, Project[]> = {
  UX: [
    ...
    { title: "AI Mobile Design Builder", category: "Web App", year: "2026", client: "JobNimbus Design Team", heroImageUrl: "/Ai Mobile Design builder/project hero.png", thumbnailUrl: "/Ai Mobile Design builder/forge hero.png", thumbnailPosition: "center" },
