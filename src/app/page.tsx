...
const workProjects: Record<string, Project[]> = {
  UX: [
    ...
    { title: "AI Mobile Design Builder", category: "Web App", year: "2026", client: "JobNimbus Design Team", thumbnailUrl: "/Ai Mobile Design builder/forge hero.png", thumbnailPosition: "center" },
