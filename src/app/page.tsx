...
type Project = { title: string; category: string; year: string; client?: string; tagline?: string; challenge?: string; heroImageUrl?: string; challengeImageUrl?: string; subProjects?: SubProject[]; outcomes?: { stats: Outcome[]; reflection: string }; embedUrl?: string; thumbnailUrl?: string; thumbnailPosition?: string };
...
const workProjects: Record<string, Project[]> = {
  UX: [
    ...
    { title: "AI Mobile Design Builder", category: "Mobile", year: "2026", client: "JobNimbus Design Team", tagline: "Mobile was the last thing anyone thought about when AI came along. Forge changed that.", heroImageUrl: "/Ai Mobile Design builder/project hero.png", challengeImageUrl: "/Ai Mobile Design builder/dual forge.png", thumbnailUrl: "/Ai Mobile Design builder/forge hero.png", thumbnailPosition: "center", challenge: "Every AI design tool on the market was built with the web in mind. Ask one to produce a native mobile component and it falls apart — wrong patterns, wrong spacing, no concept of Swift or Android conventions. Designers working in mobile had no equivalent of what web teams were getting. The problem: our design system, Forge, had everything we needed — tokens, components, brand foundations — but it only spoke to web. The opportunity was to extend Forge with native mobile components and connect it to an AI layer that could generate live mobile prototypes, not web mockups dressed up to look like apps." },
